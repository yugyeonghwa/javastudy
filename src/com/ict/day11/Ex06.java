...
public class Ex06 {
	public static void main(String[] args) {
		...
		// set을 이용해서 멤버필드의 값을 변경했던 것을 
		// 생성자를 이용해서 변경하자
		
		Ex05 coff = new Ex05("커피음료", 1500);
		// coff.sName("커피음료");
		// coff.sPrice(1500);

		Ex05 ion = new Ex05("이온음료", 2300);
		// ion.sName("이온음료"); 
		// ion.sPrice(2300); 

		Ex05 cola = new Ex05("탄산음료", 2000);
		// cola.sName("탄산음료");
		// cola.sPrice(2000);

		Ex05 juice = new Ex05("과일음료", 1800);
		// juice.sName("과일음료");
		// juice.sPrice(1800);

		Ex05[] arr = { coff, ion, cola, juice };
